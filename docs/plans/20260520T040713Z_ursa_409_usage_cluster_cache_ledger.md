...
| URSA-009 | Live Ursa restart | Restart only Ursa and validate deployed behavior. | OPEN | feature_implementation | Gate 5 | orchestrator |  |  |  |
