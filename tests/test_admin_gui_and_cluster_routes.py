...
class DummyClusterInfo:
    ...
    def to_dict(self, include_sensitive: bool = True):
        payload = {
            ...
            "daylily_ec_pinned_version": "5.0.19",
            "aws_console_url": (
            ...
            "headnode_probes": {
                "static": {
                    ...
                    "data": {
                        "daylily_ec_pinned_version": "5.0.19",
                        "remote_daylily_ec_version": "5.0.19",
...
def _create_test_app(*, admin: bool = True, email: str = "alice@lsmc.com"):
    ...
    with (
        ...
        patch(
            "daylib_ursa.workset_api.get_ursa_config",
            return_value=SimpleNamespace(
                config_path=Path("/opt/dayhoff/repo/.dayhoff/deployments/inflec3/config/ursa.yaml")
            ),
        ),
...
def test_admin_routes_cover_me_user_search_client_tokens_and_clusters() -> None:
    ...
    assert cluster_detail.json()["daylily_ec_pinned_version"] == "5.0.19"
